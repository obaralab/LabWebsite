...
{%
  include figure.html
  image="images/Julissa-Team/Julissa1.jpg"
  caption="Funnel Cake and friends! "
  link="team"
%}
{%
  include figure.html
  image="images/Julissa-Team/Julissa2.jpg"
  caption="According to Einstein, it’s right there..."
  link="team"
%}

{%
  include figure.html
  image="images/Julissa-Team/Julissa3.png"
  caption="Telescope time! Curious at every scale"
  link="team"
%}
{%
  include figure.html
  image="images/Julissa-Team/Julissa4.jpg"
  caption="Powered by cannoli (Boston edition)"
  link="team"
%}
